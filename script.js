...
var Qdata = [
  "Q1: Which building is known as “White Marble Mughal Architecture”? QQ qqa) Taj Mahal qqb) Khajurao qqc) Hampid qqd) Ajanta",
  "Q2: Which heritage site depictthe fine Dravidian style of art and Architecture? QQ qqa) Aksardham qqb) Khajuraho qqc) Hampi qqd) Ajanta",
  "Q3: What was built by emperor Shah Jahan when he shifted his capital from Agra to Delhi? QQ qqa) Taj qqb) Qutub minar qqc) Red Fort qqd) Sanchi",
];
var Adata = [
